...
import { Args, Command /*, BORGEYES_SYNTHESIS*/ } from './types';
...
// import BorgeyesStatsController from './controllers/borgeyesStats.controller';
...
export const handleCommand = async (command: Command, args: Args, username: string, message: Discord.Message) => {
    switch (command) {
        ...
        //     message.channel.send(`Rolled a ${result === 56 ? 'borgeyes' : result}`);
        //     break;
        ...
        //         name: synthesis,
        //         value: BORGEYES_SYNTHESIS,
        //     });
        //     const synthesisMessage = await message.channel.send(synthMessageEmbed);
        //     Message.reactApproveRejectEmojis(synthesisMessage);
        //     break;
        // case Command.Thanks:
        //     const borgeyesStats = await BorgeyesStatsController.ThankBorgeyes();
        //     message.channel.send(`I appreciate you! I've been thanked ${borgeyesStats.thanksCount} times!`);
        //     break;
        // case Command.Graph:
